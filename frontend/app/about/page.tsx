...
export default function AboutPage() {
  return (
    <div className="min-h-screen">
      ...
      {/*Our Mission Vison*/}
      <div className=" flex flex-col sm:flex-row justify-center gap-10 p-10 ">
        <VisMisCard logo={<Check />} title="Mission" description="To design and deliver exceptional tensile structures that combine aesthetics, performance, and practicality—empowering spaces to become more functional, adaptable, and visually striking.
                                                                  We are committed to providing cost-effective, eco-conscious, and innovative solutions that exceed expectations and transform architectural landscapes across industries."
        />
        <VisMisCard logo={<Eye />} title="Vision" description="To be recognized as a leading force in tensile architecture, known for shaping iconic structures that span possibilities—literally and figuratively.
                                                              We aim to set new standards in design adaptability, structural elegance, and sustainable construction, making Divinam Structuray a name synonymous with architectural brilliance and engineering trust."  />
